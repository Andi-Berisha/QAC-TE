...
const FilmClassification = () => {
    ...
    const players = [
        {
            Classification: <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/BBFC_U_2019.svg/1024px-BBFC_U_2019.svg.png" class="center" />,
            Description: "Suitable for all - There is nothing unsuitable for children aged four years and over."
        },

        {
            Classification: <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/BBFC_PG_2019.svg/1024px-BBFC_PG_2019.svg.png" class="center" />,
        ...
        {
            Classification: <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/45/BBFC_12_2019.svg/1024px-BBFC_12_2019.svg.png" class="center" />,
